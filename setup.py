...
MODULES_CFLAGS = [os.getenv('UVLOOP_OPT_CFLAGS', '-O3')]
...
class uvloop_build_ext(build_ext):
    ...
    def build_extensions(self):
        if self.use_system_libuv:
            ...
            self.extensions[2].extra_objects.extend([libuv_lib])
